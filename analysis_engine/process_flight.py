...
if __name__ == '__main__':
    ...
    process_flight(hdf_copy, {'Tail Number': args.tail_number,
                   ...
                   draw=args.plot,
                   required_params=['ATR Angle of Attack',
                                    'ATR Acceleration Lateral',
                                    'ATR Acceleration Longitudinal',
                                    'ATR Acceleration Vertical',
                                    'ATR Aileron',
                                    'ATR Airspeed Indicated',
                                    'ATR Airspeed True',
                                    'ATR Altitude Radio',
                                    'ATR Altitude STD',
                                    'ATR Dynamic Pressure',
                                    'ATR Flap',
                                    'ATR Groundspeed',
                                    'ATR Heading',
                                    'ATR Heading Continuous',
                                    'ATR Heading True',
                                    'ATR Heading True Prepared',
                                    'ATR Latitude',
                                    'ATR Longitude',
                                    'ATR Mach',
                                    'ATR Pitch',
                                    'ATR Inertial Velocity Downwards',
                                    'ATR Roll',
                                    'ATR Rudder',
                                    'ATR Seconds From Midnight',
                                    'ATR Seconds From Liftoff',
                                    'ATR Track Angle True',
                                    'ATR Track Prepared',
                                    'ATR Weight Gross'])
