    ...
    def derive(self, loc_rng=P('ILS Localizer Range'),
        ...
        for approach, approach_section in zip(approach_info.value, approaches):
            ...
            if gs_2_loc:
                ...
                self.array[s] = loc_rng.array[s] - gs_2_loc
            else:
                continue
...
class CoordinatesSmoothed(object):
    ...
    '''
    def taxi_out_track_pp(self, toff_slice, lat, lon, lat_adj, lon_adj, speed, hdg, freq):
        '''
    ...
    def taxi_in_track_pp(self, this_loc, lat, lon, lat_adj, lon_adj, speed, hdg, freq):
        ...
        '''
        # We transition at the end of the localizer computed phase to avoid
        # any wavy tracks between the two computations.
        ...
        if loc_est:
            for this_loc in loc_est:    
                ...
                if runway and 'localizer' in runway:
                    ...
                    self.warning("No localizer for approach runway '%s'.",
                                 runway)
