...
class AltitudeRadio(DerivedParameterNode):
    ...
    def derive(self, frame = A('Frame'),
        ...
        if frame_name in ['737-3C']:
            ...
            if frame_qualifier and 'Altitude_Radio_D226A101_1_16D' in frame_qualifier:
            ...
            elif frame_qualifier and 'Altitude_Radio_EFIS' in frame_qualifier:
                self.array, self.frequency, self.offset = \
...
class MagneticVariation(DerivedParameterNode):
    ...
    def derive(self, head=P('Heading Continuous'),
        ...
        date, but this has not been tested. The function interpolate and
        extend should operate perfectly well with multiple known variations.
