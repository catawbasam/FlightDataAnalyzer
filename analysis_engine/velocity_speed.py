...
class B757_200_RB211_535E4(VelocitySpeed):
    ...
    '''
    interpolate = True
    source = 'Boeing manual' # We are not aware of the original source's name.
    weight_unit = 'kg'
    tables = {
        'v2': {
            'weight': (62000, 64000, 66000, 68000, 70000, 72000, 74000, 76000, 78000, 80000, 82000, 84000, 86000, 88000, 90000, 92000, 94000, 96000, 98000, 100000, 102000, 104000, 106000, 108000, 110000, 112000, 114000, 116000),
